...
data_asset = context.get_datasource("spark_data_source").get_asset("spark_dataframe")

data_asset.build_batch_request(dataframe=df)


# run checks again
checkpoint_run_results = context.run_checkpoint(checkpoint_name="my_checkpoint")
